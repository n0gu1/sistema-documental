...
function UsersView({ globalQuery = '', organizationId }) {
  ...
  return <div className="users-view">
    ...
    {error && <p className="users-error" role="alert">{error}</p>}
    {notice && <p className="users-notice" role="status">{notice}</p>}
    {selectedUser && !editingUser && <PermissionButton permission="usuarios.gestionar" type="button" onClick={() => setEditingUser(selectedUser)}><UserIcon name="edit" /> Editar usuario seleccionado</PermissionButton>}
