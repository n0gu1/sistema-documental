...
function RolesView({ globalQuery = '' }) {
  ...
  return <div className="roles-view">
    ...
    {selectedRole && !editingRole && <PermissionButton permission="roles.gestionar" type="button" onClick={() => setEditingRole(selectedRole)}>Editar rol seleccionado</PermissionButton>}
